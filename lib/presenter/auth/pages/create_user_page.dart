      ...
      body: Padding(
        ...
        child: Container(
          child: ListView(children: [
            ...
            InputWidget(
                Icons.lock, "Confirmar Senha", controllerPasswordConfirm),
            SizedBox(
              height: ScreenSize.getHeight(context) * 0.02,
            ),
            GestureDetector(
              onTap: () {
                authController.createUser(CreateUserEntity(controllerEmail.text,
            ...
            Observer(builder: (context) {
              if (authController.isLoadingCreateUser) {
                return Center(
            ...
            Observer(builder: (context) {
              return Text(authController.createUserResult);
            }),
            SizedBox(
              height: ScreenSize.getHeight(context) * 0.04,
            ),
